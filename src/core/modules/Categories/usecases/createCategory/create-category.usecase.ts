...
import { CorrectAdminDetailsUsecase } from '../../../CorrectAdmin/usecases/correct-admin.usecase';
...
export class CreateCategoryUsecase {
  ...
  async execute(
    ...
    const adminDetails = await this.correctAdminUsecase.getCorrectAdmin(
      data.correct_admin_uuid,
    );
    ...
    if (categoryByName) throw new UnauthorizedException();
    //create
